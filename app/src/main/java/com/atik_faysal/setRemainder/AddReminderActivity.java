package com.atik_faysal.setRemainder;
...
import com.atik_faysal.reminder.AlarmScheduler;
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    @Override
    public void onTimeSet(TimePickerDialog view, int hourOfDay, int minute,int seconde) {
        mHour = hourOfDay;
        mMinute = minute;
        if (minute < 10) {
